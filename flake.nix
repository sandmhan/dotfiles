{
  ...
  outputs =
    ...
    let
      ...
      # Re-export the standalone SandVim Home Manager module while keeping the
      # dotfiles-specific myHome adapter local to this repository.
      sandvimHomeManagerModule = sandvim.homeManagerModules.default;
    ...
    in
    {
      ...
      inherit (sandvim) packages checks;
