...
|--------|--------|-------------|---------------|
| **forgejo.nix** | ✅ Complete | Forgejo Git server with PostgreSQL and metrics | [Forgejo Setup](../operations/services/forgejo-setup.md) |
| **frigate.nix** | ✅ Complete | Network Video Recorder with AI detection | [Frigate NVR Setup](../operations/services/frigate-nvr-setup.md) |
| **homeassistant.nix** | ✅ Complete | Home Assistant + MQTT stack | [Home Assistant Setup](../operations/services/homeassistant-setup.md) |
...
| **llama.nix** | ✅ Complete | Local AI inference server (llama.cpp) | [AI Server Setup](../operations/services/llama-ai-server-setup.md) |
| **manga/default.nix** | ✅ Complete | Manga stack wrapper for Komga, Suwayomi, and monitoring | [Manga Setup](../operations/services/manga-setup.md) |
| **matrix.nix** | ✅ Complete | Matrix homeserver (Synapse + Coturn) | [Matrix Setup](../operations/secrets/sops-secrets-setup.md#matrix-secrets) |
| **matrix-agent-bridge.nix** | ✅ Complete | Matrix webhook bridge for agent control | [Agent Bridge Setup](../operations/services/matrix-agent-bridge-setup.md) |
| **media.nix** | ✅ Complete | Jellyfin + Sonarr/Radarr/Prowlarr/qBittorrent/SABnzbd stack | *See infrastructure registry* |
| **monitoring.nix** | ✅ Complete | Prometheus + Grafana observability stack | [Monitoring Setup](../operations/services/monitoring-setup.md) |
| **nas.nix** | ✅ Complete | NFS/Samba NAS services | *See infrastructure registry* |
| **sops.nix** | ✅ Complete | Encrypted secrets management | [SOPS Setup](../operations/secrets/sops-secrets-setup.md) |
| **sunshine-server.nix** | ✅ Complete | Headless Sunshine game-streaming server | [Gaming Setup](../operations/services/gaming-setup.md) |
| **tailscale.nix** | ✅ Complete | Tailscale subnet router for current remote access | *See infrastructure registry* |
| **wger.nix** | ✅ Complete | wger fitness tracking OCI stack | [Fitness Setup](../operations/services/fitness-setup.md) |
| **wireguard.nix** | ✅ Retained/planned | WireGuard VPN module; not the currently deployed remote-access path | [WireGuard Setup](../operations/networking/wireguard-client-configs.md) |
