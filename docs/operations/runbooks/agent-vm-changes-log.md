...
These helper commands document the original deployment workflow and remain useful for redeployments, but current deployed status should be checked against `docs/architecture/infrastructure-registry.md` first.
...
**`docs/plans/autonomous-agent-vm-roadmap.md`**
...
**`docs/operations/services/agent-vm-setup.md`**
...
**`docs/operations/runbooks/agent-vm-changes-log.md`** (this document)
