...
> **Status:** historical runbook. Retained for lessons learned from earlier VMA-based deployment work. The preferred future provisioning strategy is captured in [ADR003](../../adr/ADR003-proxmox-provisioning-strategy.md) and Phase 3.
