...
- `docs/architecture/infrastructure-registry.md` — canonical homelab deployment status, VM IDs, IPs, and service inventory.
...
3. Update `docs/architecture/infrastructure-registry.md` in the same change as any host or deployment-status change.
